...
const Game = () => {
    ...
    return (
        ...
        <ScrollView className='flex-1'
            ...
            <SafeAreaView className='justify-center landscape:mb-20' style={{ backgroundColor: currentTheme.background }}>
                ...
                {isGameReady && (
                    <View className='p-4 gap-6 landscape:flex-row landscape:justify-center'>
                        ...
                        {!isLoading && gameOptions.length > 0 && (
                            <View className='landscape:w-1/2 landscape:justify-end landscape:gap-6'>
                                <AppGameOptions
